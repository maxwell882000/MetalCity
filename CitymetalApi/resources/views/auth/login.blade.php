...
<head>
    ...
    <title>Вход | CityMetal</title>

    <meta name="description" content="Административная панель CityMetal">
                ...
                <div class="hero-static col-md-6 col-xl-4 d-flex align-items-center bg-white invisible" data-toggle="appear" data-class="animated fadeInRight">
                    <div class="content content-full">
                        ...
                        <div class="px-30 py-10">
                            ...
                            <h1 class="h3 font-w700 mt-30 mb-10">Добро пожаловать в административную панель Telegram бота CityMetal</h1>
