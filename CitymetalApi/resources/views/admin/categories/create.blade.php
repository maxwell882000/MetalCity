        ...
        <form action="{{ route('admin.categories.store') }}" method="post" enctype="multipart/form-data">
            ...
            <div class="block-content">
                ...
                <div class="form-group">
                    ...
                    @else
                        <select name="parent_id" id="select2" class="form-control js-select2">
                            <option value="{{request()->category_id}}" selected>{{$category_id->ru_title}}</option>
                            <option value="0">-- нет --</option>
                        </select>
                    @endif
                </div>
                <div class="form-group @error('order') is-invalid @enderror">
                    <label for="order" class="col-form-label">Порядок</label>
                    <input class="form-control" type="number" id="order" name="order" value="{{ old('order', 0) }}">
                </div>
            </div>
            <div class="block-content">
