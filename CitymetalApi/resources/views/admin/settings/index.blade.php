    ...
    <form action="{{ route('admin.settings.store') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="block">
            ...
            <div class="block-content">
                ...
                <h2 class="content-heading">Настройка группы / канала для оповещений</h2>
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="notification_group">ID канала / группы</label>
                            <input name="notification_group" id="notification_group" class="form-control" value="{{ $settings->notification_group }}">
                        </div>
                    </div>
                </div>
            </div>
