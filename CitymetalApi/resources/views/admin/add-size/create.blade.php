...
@section('title') Добавить размер @endsection

@section('content')

    <div class="block">
        <div class="block-header block-header-default">
            <h3 class="block-title">Добавить размер</h3>
        </div>
        <!-- Form -->
        <form action="{{ route('admin.add-size.store') }}" method="post" enctype="multipart/form-data">
            @csrf
...
<input hidden name="parent" value="{{$id}}">
            <div class="block-content">
