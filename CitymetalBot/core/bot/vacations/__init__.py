...
create_vacation_conversation = ConversationHandler(
    ...
    states={
        create.TITLE: [MessageHandler(Filters.text, create.vacation_title),
                        CallbackQueryHandler(create.vacation_title)],
        create.CONFIRM: [CallbackQueryHandler(create.vacation_confirm), MessageHandler(Filters.text, main_menu_handler)],
        create.PRICE: [MessageHandler(Filters.text, create.vacation_price), CallbackQueryHandler(create.vacation_price)],
        create.UNIT: [MessageHandler(Filters.text, create.vacation_unit), CallbackQueryHandler(create.vacation_unit)],
        create.CONTACTS: [MessageHandler(Filters.text, create.vacation_contacts), CallbackQueryHandler(create.vacation_contacts)],
        create.REGION: [CallbackQueryHandler(create.from_location_to_title, pattern='region:back'),
                    CallbackQueryHandler(create.vacation_region), MessageHandler(Filters.text, main_menu_handler)],
        create.CATEGORIES: [CallbackQueryHandler(create.from_categories_to_menu, pattern='category:to_menu'),
