...
CATALOG_ACTION, LOCATION_REGION, CATEGORY, VACATIONS = range(4)
...
def catalog_location_region(update: Update, context: CallbackContext):
    ...
    context.user_data['catalog']['location']['full_name'] = strings.get_string("location.regions." + region, language)
